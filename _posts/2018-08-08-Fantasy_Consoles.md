...
![A small, yet powerful slinky from sprite to finished product](https://miro.medium.com/v2/resize:fit:512/format:webp/1*Jhg3dYl7m012wWS2B74mCw.gif)
...
2.  carts that can hold 15,360 bytes of compressed code with a maximum of 65,536 characters.
3.  carts that reserve 12,544 bytes for graphics (8x8 sprites / blocks) and 4,608 bytes for sound but these can also be used for other purposes.
4.  a maximum of 256 sprites though these can be sacrificed for more map space.
5.  and a small, reserved and inaccessible amount of space in each cart for the lua interpreter.
...
![The command line](https://miro.medium.com/v2/resize:fit:768/format:webp/0*1ReqsXW8Nf25bpgJ.png)
...
![SPLORE is constantly updated so users can see new games consistently.](https://miro.medium.com/v2/resize:fit:768/format:webp/0*VThRmacpJ1_BtbIO.png)

**The SPLORE menu** is a tiny graphic interface that let’s you look at various demo _cartridges_ for PICO-8 as well as a number of recent uploads to the PICO-8 community. This tiny menu will download cartridges to your computer allowing whoever downloaded them to look at each of the interface screens to see how they’ve done something. As it stands, each cartridge is a tiny text-file with the file extension “.p8”. While all editing can occur within PICO-8, they can also be edited by any program that can deal with text files. There is also a neat [extension for Sublime that mimics the code editor of PICO-8](https://packagecontrol.io/packages/PICO-8).
...
![The Code Editor](https://miro.medium.com/v2/resize:fit:768/format:webp/0*ZerHdYq50Anbi66J.png)
...
![The Sprite Editor](https://miro.medium.com/v2/resize:fit:768/format:webp/0*zaDSxi0AlQsZUf-q.png)
...
![The Map Editor](https://miro.medium.com/v2/resize:fit:768/format:webp/0*WyOyqyBZXbXCdvQQ.png)
...
![The Sound Effects Editor](https://miro.medium.com/v2/resize:fit:768/format:webp/0*JscRiJi29JqLZTAj.png)
...
![The Music Editor](https://miro.medium.com/v2/resize:fit:768/format:webp/0*GOXnOjUfvqsBjCns.png)
...
2.  the expectations of users creating games,
3.  and the “trendiness” of a retro-oriented re-interpretation of the hardware limitations that fostered truly unique and memorable video games
